import { NETWORK_AWARE_PRELOADING_CHECK } from 'lib/tokens/network-aware-preloading-check';
import { CONNECTION_TYPE_BLACKLIST } from 'lib/tokens/connection-type-blacklist';
import { EFFECTIVE_CONNECTION_TYPE_BLACKLIST } from 'lib/tokens/effective-connection-type-blacklist';
...
import { NAVIGATOR } from 'lib/tokens/navigator-ref';


@Injectable()
export class NetworkAwarePreloadingStrategyPlugin extends PreloadingStrategyPlugin {

  public readonly referralPhrase: string = 'networkAwarePreload';
